...
def validate_data(age, investment_amount, first_name, intent_request):
    """
    ...
    # Results returned if age and amount are valid
    return build_validation_result(True, None, None)
...
def recommend_portfolio(intent_request):
  ...
  if source == "DialogCodeHook":
        ...
        validation_result = validate_data(age, investment_amount, first_name, intent_request)
